...
export default function ContactPage() {
  const socialLinks = [
    { icon: <FaTwitter />, name: 'Twitter (X)', url: 'https://twitter.com/Picasso_Card' },
    // { icon: <FaFacebookF />, name: 'Facebook', url: 'https://facebook.com' },
    { icon: <FaLinkedinIn />, name: 'LinkedIn', url: 'https://www.linkedin.com/company/picasso-card/' },
    { icon: <FaInstagram />, name: 'Instagram', url: 'https://www.instagram.com/picasso_card/' }
  ];
  ...
  return (
    <div style={{ position: 'relative', fontFamily: 'Arial, sans-serif', fontSize, height: '100vh', color: '#ffffff' }}>
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <a href="mailto:contact@company.com" style={{ 
              color: '#ffffff', 
              textDecoration: 'none', 
              fontSize: pSize, 
              wordWrap: 'break-word', 
          ...
          <div style={{ marginBottom: '2rem' }}>
            {socialLinks.map((link, index) => (
              <div key={index} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '10px 0' }}>
                <a href={link.url} style={{ color: '#ffffff', textDecoration: 'none', display: 'flex', alignItems: 'center', fontSize: '1.25rem' }}>
                  {link.icon}
